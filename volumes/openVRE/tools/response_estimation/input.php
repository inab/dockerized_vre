  ...
  <?php require "../../htmlib/menu.inc.php"; ?>
	...
	<div class="page-content">
    	...
    	<div class="row">
    		...
    		<?php } ?>
 		<form action="#" class="horizontal-form" id="tool-input-form" method="POST">
		...
		<!-- BEGIN PORTLET 1: PROJECT -->
		 ...
		 <div class="portlet box blue form-block-header" id="form-block-header1">
			 ...
			 <div class="form-body">
			     ...
			     <div class="row">
				<div class="col-md-6">
                                     <?php $ff = matchFormat_File($tool['input_files']['sample_data'], $inPaths); ?>
				     <?php InputTool_printSelectFile($tool['input_files']['sample_data'], $rerunParams['sample_data'], $ff, true, true); ?>
                                 </div>
				<div class="col-md-6">
                                     <?php $ff = matchFormat_File($tool['input_files']['sample_masks'], $inPaths); ?>
				     <?php InputTool_printSelectFile($tool['input_files']['sample_masks'], $rerunParams['sample_masks'], $ff, true, true); ?>
                                 </div>
                             </div>
			     <div class="row">
                                 <div class="col-md-6">
                                      <?php $ff = matchFormat_File($tool['input_files_public_dir']['model_preloaded']['file_type'], $inPaths); ?>
                                       <?php InputTool_printListOfFiles($tool['input_files_public_dir']['model_preloaded'], $rerunParams['model_preloaded'], $ff[0], false, true); ?>
                                  </div>
                                 <div class="col-md-6">
                                  </div>
			     </div>
