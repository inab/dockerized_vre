        ...
        <!-- BEGIN PAGE BAR -->
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li><span>Admin</span><i class="fa fa-circle"></i></li>
					<li><a href="admin/myNewTools.php">My new tools</a><i class="fa fa-circle"></i></li>
                    <li><span>Tool specification</span></li>
                </ul>
            </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title">Tool specification</h1>
        <!-- END PAGE TITLE-->
		<!-- END PAGE HEADER-->
