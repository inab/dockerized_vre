...
<!-- BEGIN CONTENT -->
	...
	<!-- BEGIN CONTENT BODY -->
		...
		<!-- END PAGE BAR -->
		<!-- BEGIN PAGE TITLE-->
			<h1 class="page-title"> Generate Test Files</h1>
		<!-- END PAGE TITLE-->
	<!-- END PAGE HEADER-->
	...
	<form name="create-test" id="create-test" action="applib/updateToolDevTest.php" method="post" >
		...
		<div class="portlet box blue-oleo">
			...
			<div class="portlet-body form">
				<div class="form-body">
					<p>You are to develop your tool code offline, in a local environmet (i.e VM).
					And to best way to check that your tool is going to be properly called by VRE server
					when integrated into the cloud, is precisely emulating a VRE execution to you tool code.
					Fill in this form with the test input files that you have in your development environent,
					and use the resulting JSON files to create your test script</p>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label class="control-label">Test working directory <i class="icon-question popovers" data-container="body" data-content="Correspond to the local working directory of your tool. In there is where output files and logs are expected." data-html="true" data-original-title="Foo execution folder" data-trigger="hover"></i></label>
<?php
...
?>
							...
							<div class="col-md-6">
								<div class="form-group">
									<label class="control-label">Tool wrapper <i class="icon-question popovers" data-container="body" data-content="TODO" data-html="true" data-original-title="Foo execution folder" data-trigger="hover"></i></label>
<?php
...
?>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label class="control-label">Workflow type <i class="icon-question popovers" data-container="body" data-content="What is it?." data-html="true" data-original-title="Foo project Id" data-trigger="hover"></i></label>
<?php $val = $toolDevMetaJSON["step1"]["form_data"]["workflowtype"]; ?>
							...
							<div class="col-md-6">
								...
								<label class="control-label">Tool python libraries <i class="icon-question popovers" data-container="body" data-content="TODO" data-html="true" data-original-title="Foo execution folder" data-trigger="hover"></i></label>
<?php
...
<!---------------  SETTING INPUT FILES -->
					...
					<div class="row margin-top-20">
						<div class="col-md-12">
							<div class="form-group">
								<label class="control-label"><?php echo $inputf["description"] ?><i class="icon-question popovers" data-container="body" data-content="<?php echo getInputMetadata($inputf); ?>" data-html="true" data-original-title="Metadata for <?php echo $inputf["description"] ?>" data-trigger="hover"></i></label>
...
?>
							...
							<div class="col-md-6" style="background:#e9e9e9;margin-left:<?php echo $ml; ?>px;margin-top: -15px;padding-top: 15px;">
								<div class="form-group">
									...
									<?php $val = $toolDevMetaJSON["step1"]["form_data"]["metadata"][$inputf["name"]]; ?>
									<input type="text" name="metadata[<?php echo $inputf["name"]; ?>][<?php echo $feature; ?>]" value="<?php echo $val[$feature]; ?>" class="form-control input-files" style="width:95%;">									</div>
								</div>
<?php
			$c ++;
		}
