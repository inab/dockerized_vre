...
function viewProgress(pid, name, type) {
    ...
    switch (type) {
        ...
        case 'PENDING':
            $('#modalProgress .modal-header .modal-title').html(globFileName.toUpperCase() + ' <span>Job Pending</span>');
        ...
        case 'FINISHING':
            $('#modalProgress .modal-header .modal-title').html(globFileName.toUpperCase() + ' <span>Job Finishing</span>');
        ...
        case 'RUNNING':
            $('#modalProgress .modal-header .modal-title').html(globFileName.toUpperCase() + ' <span>Progress</span>');
...
viewResults = function(execution, tool) {
    ...
    // JL Redirect to output.php, no check for statistics.
